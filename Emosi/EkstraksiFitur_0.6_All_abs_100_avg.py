...
nstim1 = 20 #jumlah file stimulus 1
nstim2 = 22
nstim3 = 17
nstim4 = 18
...
def save(n):
    for i in range(len(Fp1_delta_psd)):
        ...
        with open ('fitur_emosi_all_100_abs_avg_easym.csv', mode='a', newline = '') as fitur_emosi:
...
#            with open ('filter_100.csv', mode='a', newline = '') as params:
#                fitur_writer = csv.writer(params, delimiter = ',')
#                fitur_writer.writerow(channel_data())
#            print (ChN[m])
            m = m + 1
