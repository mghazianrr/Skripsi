...
def save(n):
    for i in range(len(Fp1_delta_psd)):
        Fp12_delta_psd = (Fp1_delta_psd[i]-Fp2_delta_psd[i])
        Fp12_theta_psd = (Fp1_theta_psd[i]-Fp2_theta_psd[i])
        Fp12_alpha_psd = (Fp1_alpha_psd[i]-Fp2_alpha_psd[i])
        Fp12_beta_psd = (Fp1_beta_psd[i]-Fp2_beta_psd[i])
        Fp12_gamma_psd = (Fp1_gamma_psd[i]-Fp2_gamma_psd[i])
        F34_delta_psd = (F3_delta_psd[i]-F4_delta_psd[i])
        F34_theta_psd = (F3_theta_psd[i]-F4_theta_psd[i])
        F34_alpha_psd = (F3_alpha_psd[i]-F4_alpha_psd[i])
        F34_beta_psd = (F3_beta_psd[i]-F4_beta_psd[i])
        F34_gamma_psd = (F3_gamma_psd[i]-F4_gamma_psd[i])
        C34_delta_psd = (C3_delta_psd[i]-C4_delta_psd[i])
        C34_theta_psd = (C3_theta_psd[i]-C4_theta_psd[i])
        C34_alpha_psd = (C3_alpha_psd[i]-C4_alpha_psd[i])
        C34_beta_psd = (C3_beta_psd[i]-C4_beta_psd[i])
        C34_gamma_psd = (C3_gamma_psd[i]-C4_gamma_psd[i])
        P34_delta_psd = (P3_delta_psd[i]-P4_delta_psd[i])
        P34_theta_psd = (P3_theta_psd[i]-P4_theta_psd[i])
        P34_alpha_psd = (P3_alpha_psd[i]-P4_alpha_psd[i])
        P34_beta_psd = (P3_beta_psd[i]-P4_beta_psd[i])
        P34_gamma_psd = (P3_gamma_psd[i]-P4_gamma_psd[i])
        O12_delta_psd = (O1_delta_psd[i]-O2_delta_psd[i])
        O12_theta_psd = (O1_theta_psd[i]-O2_theta_psd[i])
        O12_alpha_psd = (O1_alpha_psd[i]-O2_alpha_psd[i])
        O12_beta_psd = (O1_beta_psd[i]-O2_beta_psd[i])
        O12_gamma_psd = (O1_gamma_psd[i]-O2_gamma_psd[i])
        F78_delta_psd = (F7_delta_psd[i]-F8_delta_psd[i])
        F78_theta_psd = (F7_theta_psd[i]-F8_theta_psd[i])
        F78_alpha_psd = (F7_alpha_psd[i]-F8_alpha_psd[i])
        F78_beta_psd = (F7_beta_psd[i]-F8_beta_psd[i])
        F78_gamma_psd = (F7_gamma_psd[i]-F8_gamma_psd[i])
        T34_delta_psd = (T3_delta_psd[i]-T4_delta_psd[i])
        T34_theta_psd = (T3_theta_psd[i]-T4_theta_psd[i])
        T34_alpha_psd = (T3_alpha_psd[i]-T4_alpha_psd[i])
        T34_beta_psd = (T3_beta_psd[i]-T4_beta_psd[i])
        T34_gamma_psd = (T3_gamma_psd[i]-T4_gamma_psd[i])
        T56_delta_psd = (T5_delta_psd[i]-T6_delta_psd[i])
        T56_theta_psd = (T5_theta_psd[i]-T6_theta_psd[i])
        T56_alpha_psd = (T5_alpha_psd[i]-T6_alpha_psd[i])
        T56_beta_psd = (T5_beta_psd[i]-T6_beta_psd[i])
        T56_gamma_psd = (T5_gamma_psd[i]-T6_gamma_psd[i])
        ...
        with open ('fitur_emosi_all_v6.csv', mode='a', newline = '') as fitur_emosi:
